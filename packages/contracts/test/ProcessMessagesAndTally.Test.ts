...
const stateTreeDepth = 10  // config.maci.merkleTrees.stateTreeDepth,
    ...
    */
    describe('Publish messages', () => {
      const compareMACIAndMACIStateRoots = async () => {
        ...
        S.maciState.stateAq.merge(stateTreeDepth)
        const maciStateRoot = S.maciState.stateAq.getRoot(stateTreeDepth)
